...
analytics_patterns = ([
    ...
    path('revision-18-puntos/historial', views.rev18puntos, name="rev18puntos"),
    path('revision-18-puntos/historial/ver/<int:rev_id>', views.f18puntos_historial_show, name="f18puntos_historial_show"),
    path('capacitaciones/historial', views.CapacitacionesListView.as_view(), name="capacitaciones"),    
    path('capacitacion/<int:pk>', views.CapacitacionDetailView.as_view(), name="capacitacion_detail"),    
    ...
    path('controlpatios/dashboard', views.controlp_dashboard, name="controlp_dashboard"),
    ...
    path('registro_visitantes',views.registro_visitantes,name="registro_visitantes"),
    path('previsitantes',views.previsitantes, name="previsitantes"),
    path('registro_previsitantes',views.registro_previsitantes, name="registro_previsitantes"),
