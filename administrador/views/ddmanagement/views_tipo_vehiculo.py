...
from ddmanagement.forms import TipoVehiculoForm
...
class TipoVehiculoListView(ListView):
    model = TipoVehiculo    
    template_name = 'administrador/ddmanagement/tipo_vehiculo_list.html'   
...
class TipoVehiculoDetailView(DetailView):
    model = TipoVehiculo    
    template_name = 'administrador/ddmanagement/tipo_vehiculo_detail.html' 
...
class TipoVehiculoUpdateView(UpdateView):
    ...
    template_name = 'administrador/ddmanagement/tipo_vehiculo_update_form.html'    
    
    def get_success_url(self):
        return reverse_lazy('administrador:tipo_de_vehiculo_update', args=[self.object.id]) + '?OK'
...
class TipoVehiculoCreateView(CreateView):
    model = TipoVehiculo        
    form_class = TipoVehiculoForm 
    template_name = 'administrador/ddmanagement/tipo_vehiculo_form.html'    
    
    def get_success_url(self, *args, **kwargs):        
        return reverse('administrador:tipo_de_vehiculo_list')
...
class TipoVehiculoDelete(DeleteView):
    model = TipoVehiculo        
    template_name = 'administrador/ddmanagement/tipo_vehiculo_confirm_delete.html'    
    success_url =  reverse_lazy('administrador:tipo_de_vehiculo_list')  
