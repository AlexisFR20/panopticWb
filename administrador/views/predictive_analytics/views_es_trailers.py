...
def admin_es_trailers_historial(request):
    ...
    return render(request, 'administrador/predictive/es-trailers-historial.html', { 'css_list': css_list, 'js_list': js_list, 'userdict': userdict, 'user': user,  'estrailers': estrailers })
...
def admin_es_trailers_ver(request, estra_id):
	...
	return render(request, 'administrador/predictive/es-trailers-ver.html', { 'css_list': css_list, 'js_list': js_list, 'estrailer': estrailer })