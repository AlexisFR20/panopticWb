...
from analytics.forms import LogroForm
from analytics.models import Logro 
...
class LogroListView(ListView):
    model = Logro    
    template_name = 'administrador/ddmanagement/logro/logro_list.html'   
...
class LogroDetailView(DetailView):
    model = Logro    
    template_name = 'administrador/ddmanagement/logro/logro_detail.html' 
...
class LogroUpdateView(UpdateView):
    ...
    template_name = 'administrador/ddmanagement/logro/logro_update_form.html'    
    
    def get_success_url(self):
        return reverse_lazy('administrador:logros_update', args=[self.object.id]) + '?OK'
...
class LogroCreateView(CreateView):
    model = Logro        
    form_class = LogroForm 
    template_name = 'administrador/ddmanagement/logro/logro_form.html'    
    
    def get_success_url(self, *args, **kwargs):        
        return reverse('administrador:logros_list')

    #def form_valid(self, form, **kwargs):        
        #form = form.save(commit=False)                
        #form.planta = self.request.user.planta
        #form.save()
...
class LogroDelete(DeleteView):
    model = Logro        
    template_name = 'administrador/ddmanagement/logro/logro_confirm_delete.html'    
    success_url =  reverse_lazy('administrador:logros_list')  
