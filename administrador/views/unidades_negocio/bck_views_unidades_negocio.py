...
def admin_un_index(request): 
    ...
    return render(request, 'administrador/unidades_negocio/index.html', { 'css_list': css_list, 'js_list': js_list, 'userdict': userdict, 'user': user,  'all_users': all_users, 'plantas': plantas, 'plantas_relevantes': plantas_relevantes })
...
def admin_un_edit(request, un_id):     
    ...
    cinternos = User.objects.filter( cliente_id = user.cliente_id)       
    ...
    return render(request, 'administrador/unidades_negocio/edit.html', { 'css_list': css_list, 'js_list': js_list, 'userdict': userdict, 'user': user,  'all_users': all_users, 'planta': planta, 'clientes': clientes, 'cinternos': cinternos, 'cinterno_sel': cinterno_sel, 'regiones': regiones  }) 
...
def admin_sucursales_index(request): 
    ...
    return render(request, 'administrador/sucursales/index.html', { 'css_list': css_list, 'js_list': js_list, 'userdict': userdict, 'user': user,  'all_users': all_users, 'plantas': plantas, 'plantas_relevantes': plantas_relevantes })